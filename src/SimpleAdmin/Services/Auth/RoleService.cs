...
public class RoleService : IRoleService
{
    ...
    private readonly IDbContextFactory<SimpleAdminDbContext> _dbContextFactory;

    public RoleService(RoleManager<IdentityRole> roleManager, UserManager<ApplicationUser> userManager, IDbContextFactory<SimpleAdminDbContext> dbContextFactory)
    {
