...
public class Program
{
    public static async Task Main(string[] args)
    {
        ...
        .AddEntityFrameworkStores<SimpleAdminDbContext>()
        ...
        builder.Services.AddDbContextFactory<SimpleAdminDbContext>(options =>
        {
            options.UseSqlServer(builder.Configuration.GetConnectionString("DefaultConnection"));
        }, ServiceLifetime.Scoped);

        builder.Services.AddDbContext<SimpleAdminDbContext>(options =>
        {
            options.UseSqlServer(builder.Configuration.GetConnectionString("DefaultConnection"));
        }, ServiceLifetime.Scoped);
        ...
        using (var scope = app.Services.CreateScope())
        {
            ...
            try
            {
                ...
                try
                {
                    var db = services.GetRequiredService<SimpleAdminDbContext>();
