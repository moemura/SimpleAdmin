...
public class AccountService : IAccountService
{
    ...
    public async Task<AuthResponseDto> UpdateAsync(UserDto dto)
    {
        ...
        if (!result.Succeeded)
        {
            return new AuthResponseDto { Success = false, Message = "User not updated" };
        }
        else
        {
            return new AuthResponseDto { Success = true, Message = "User updated" };
        }
    }
